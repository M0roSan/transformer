...
// WithMode is an option for the Transform function that will defnie
...
func Transform(image io.Reader, ext string, numShapes int, opts ...func()) (io.Reader, error) {
	...
	if err != nil {
		return nil, errors.New("primitive: failed to create template out file")
	}
...
func tempfile(prefix, ext string) (*os.File, error) {
	...
	if err != nil {
		return nil, errors.New("primitive: failed to crate temp file")
	}
	defer os.Remove(in.Name())
